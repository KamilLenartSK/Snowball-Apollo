      ...
      test: /\.(js|jsx|mjs)$/,enforce: 'pre', use: [
        ...
        oneOf: [
          ...
          test: /\.css$/,loader: ExtractTextPlugin. extract(Object. assign({
              ...
              use: [
                {loader: require. resolve('css-loader'),options: { importLoaders: 1, minimize: true, modules: true, localIdentName: '[name]__[local]__[hash:base64:5]', sourceMap: shouldUseSourceMap
                  }
                }, {
